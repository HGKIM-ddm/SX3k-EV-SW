...
static void Antipinch_PrevOpen(void)
{
    ...
    case 4:
        ...
        if (((aaf_action == OPEN) || (aaf_action == DIAG_MODE_OPEN)) && (step_position <= (step_position_open + limit_step_position)))
        {
            Drv8889_Off();
            motor_start = OFF;
...
static void Antipinch_PrevClose(void)
{
    ...
    case 4:
        ...
        if (((aaf_action == CLOSE) || (aaf_action == DIAG_MODE_CLOSE)) && (step_position >= (step_position_close - limit_step_position)))
        {
            Drv8889_Off();
            motor_start = OFF;
